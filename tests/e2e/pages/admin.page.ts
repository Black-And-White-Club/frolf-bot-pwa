...
submitBatchButton(): Locator { return this.tagSection().getByRole('button', { name: 'Submit Batch' }); }
pointMemberSelect(): Locator { return this.page.locator(selectors.pointMemberSelect); }
pointDeltaInput(): Locator { return this.page.locator(selectors.pointDeltaInput); }
pointReasonInput(): Locator { return this.page.locator(selectors.pointReasonInput); }
adjustPointsButton(): Locator { return this.pointSection().getByRole('button', { name: 'Adjust Points' }); }
