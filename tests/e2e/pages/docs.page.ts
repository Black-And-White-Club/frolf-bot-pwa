...
sidebarNav(): Locator { return this.page.locator('nav[aria-label="Documentation navigation"]').first(); }
mobileNavToggle(): Locator { return this.page.locator('button[aria-controls="docs-mobile-nav"]'); }
mobileNav(): Locator { return this.page.locator('#docs-mobile-nav'); }
