...
<div
	class="hover:bg-liquid-skobeloff flex items-center gap-4 rounded-lg p-3 transition-colors duration-200"
>
	...
	<!-- Avatar -->
	<div class="relative">
		<ParticipantAvatar userId={entry.userId} username={displayName} size={32} />
	</div>
