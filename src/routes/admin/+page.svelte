...
<div class="min-h-screen bg-[var(--guild-background)] px-4 py-10">
	<div class="mx-auto max-w-4xl space-y-8">
		...
		<div class="flex items-center gap-3">
			<h1 class="font-['Fraunces'] text-3xl font-bold text-[var(--guild-text)]">
				Admin Dashboard
			</h1>
			<span
				class="rounded-md border border-[#B89B5E]/40 bg-[#B89B5E]/10 px-2 py-0.5 font-['Space_Grotesk'] text-xs font-semibold text-[#B89B5E] uppercase tracking-wide"
			>
				Admin
			</span>
		</div>
		...
		<div class="grid gap-6 lg:grid-cols-2">
			...
			<section class="space-y-3">
				<h2 class="font-['Space_Grotesk'] text-sm font-semibold text-[var(--guild-text-secondary)] uppercase tracking-wide">
					Tag Management
				</h2>
				<TagEditor />
			</section>
