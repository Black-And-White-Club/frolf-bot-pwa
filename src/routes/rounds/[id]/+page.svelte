...
<main class="container mx-auto px-4 py-6">
	{#if round}
		<a href="/rounds" class="text-sage-500 mb-4 inline-block hover:underline"> ← Back to rounds </a>
		<RoundDetail {roundId} />
	{:else}
		<div class="py-12 text-center">
			<p class="text-slate-400">Round not found</p>
			<a href="/rounds" class="text-sage-500 mt-2 inline-block hover:underline"> Back to rounds </a>
		</div>
	{/if}
</main>
