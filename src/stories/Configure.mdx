...
import Tutorials from '../lib/components/icons/Tutorials.svelte';
...
<div className="sb-section sb-socials">
    <div className="sb-section-item">
      <Github className="sb-explore-image" testid="icon-github" aria-label="Github logo" />
    ...
    <div className="sb-section-item">
      <Discord className="sb-explore-image" testid="icon-discord" aria-label="Discord logo" />
      <div>
    ...
    <div className="sb-section-item">
      <Youtube className="sb-explore-image" testid="icon-youtube" aria-label="Youtube logo" />
      <div>
    ...
    <div className="sb-section-item">
      <Tutorials className="sb-explore-image" testid="icon-tutorials" aria-label="Tutorials" />
...
<style>
  ...
  .sb-addon {
    ...
    align-items: center;
    position: relative;
  background-color: var(--guild-background, #EEF3F8);
    border-radius: 5px;
    border: 1px solid rgba(0, 0, 0, 0.05);
  background: var(--guild-background, #EEF3F8);
    height: 180px;
    margin-bottom: 48px;
    overflow: hidden;
  }
